...
const Card = ({ recipe }) => {
  ...
  return (
    <div
      className="bg-white shadow-lg hover:shadow-xl transition duration-300 rounded-lg overflow-hidden relative cursor-pointer"
    ...
    >
      ...
      <div className="p-5 pt-16">
        <h1 className="text-gray-800 font-bold text-xl mb-2 hover:text-gray-600">
          {recipe.title}
        </h1>
